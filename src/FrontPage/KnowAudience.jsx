...
export default function KnowAudience() {
  return (
    // bg-indigo-400
    <section className="h-[100vh] sm:h-[70vh] bg-[#366164] flex justify-center items-center">
      <div className="w-4/5 mx-auto grid grid-cols-2  opacity-70">
        ...
        <div className="col-span-2 pt-9 sm:col-span-1">
          <img className="w-full h-80 rounded-md" src={audienceImg} alt="" />
        </div>
      </div>
    </section>
  );
